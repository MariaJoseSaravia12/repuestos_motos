...
class Consulta(models.Model): 
    ...
    def estado_de_respuesta(self):
        if self.estado_respuesta == "Contestada":
            return format_html('<span style="background-color: #258a60; color:#ffffff;padding: 7px;">{}</span>',  self.estado_respuesta, )
        elif self.estado_respuesta == "No Contestada":
            return format_html('<span style="background-color: #FA150C; color:#ffffff;padding: 7px;">{}</span>', self.estado_respuesta, )
        elif self.estado_respuesta == "En Proceso":
            return format_html('<span style="background-color: #f80174; color:#ffffff; padding: 7px;">>{}</span>', self.estado_respuesta, )
